...
#include "../Lab6_OOP_1/DynamicVector.h"
#include "../Lab6_OOP_1/Controller.h"
#include "../Lab6_OOP_1/Movie.h"
#include "../Lab6_OOP_1/Repository.h"
#include "../Lab6_OOP_1/UI.h"
#include "../Lab6_OOP_1/MovieValidator.h"
#include "../Lab6_OOP_1/RepositoryExceptions.h"
#include "../Lab6_OOP_1/Watchlist.h"

#include "../Lab6_OOP_1/DynamicVector.cpp"
#include "../Lab6_OOP_1/Controller.cpp"
#include "../Lab6_OOP_1/Movie.cpp"
#include "../Lab6_OOP_1/MovieValidator.cpp"
#include "../Lab6_OOP_1/Repository.cpp"
#include "../Lab6_OOP_1/RepositoryExceptions.cpp"
#include "../Lab6_OOP_1/UI.cpp"
#include "../Lab6_OOP_1/Watchlist.cpp"
#include "../Lab6_OOP_1/main.cpp"
...
namespace UnitTestLab6OOP
{
	TEST_CLASS(UnitTestLab6OOP)
	{
	public:
		
		TEST_METHOD(test_repo_add)
		{
		...
		TEST_METHOD(test_repo_delete)
		{
			...
			m2.set_trailer("https://www.youtube.com/watch?v=Wz719b9QUqY");
			repo.AddMovie(m2);
			Assert::AreEqual(repo.getMovies().getSize(), 2);
			int id = m1.get_id();
			repo.DeleteMovie(id);
			Assert::AreEqual(repo.getMovies().getSize(), 1);
			id = m2.get_id();
			repo.DeleteMovie(id);
			Assert::AreEqual(repo.getMovies().getSize(), 0);
		...
		TEST_METHOD(test_repo_update_title)
		{
		...
		TEST_METHOD(test_repo_update_trailer)
		{
			...
			m1.set_trailer("https://www.youtube.com/watch?v=DcsirofJrlM");
			repo.AddMovie(m1);
			Assert::AreEqual(m1.get_trailer(), string("https://www.youtube.com/watch?v=DcsirofJrlM"));
			int id = m1.get_id();
		...
		TEST_METHOD(test_watchlist_add)
		{
			...
			Assert::AreEqual(wl.GetMoviesFromWatchlist().getSize(), 1);
			Movie m2{};
			m2.set_id(207);
			m2.set_title("Psycho");
			m2.set_genre("Horror");
		...
		TEST_METHOD(test_file_delete)
		{
			...
			Assert::AreEqual(repo.getMovies().getSize(), 5);
			int id = m1.get_id();
			repo.DeleteMovie(id);
			repo.DeleteMovieFromFile(id, "2 - RepoTest.txt");
			Assert::AreEqual(repo.getMovies().getSize(), 4);
			id = m2.get_id();
			repo.DeleteMovie(id);
			repo.DeleteMovieFromFile(id, "2 - RepoTest.txt");
			Assert::AreEqual(repo.getMovies().getSize(), 3);
			std::cout << "The function that deletes a movie from the file is working properly." << std::endl;
		}

		TEST_METHOD(test_file_update_title)
		{
		...
		TEST_METHOD(test_file_update_genre)
		{
		...
		TEST_METHOD(test_file_update_trailer)
		{
		...
		TEST_METHOD(test_file_update_number_of_likes)
		{
			...
			for (int i = 0; i < vector.getSize(); i++)
			{
				Movie m = movie[i];
				if (m.get_id() == id)
					Assert::AreEqual(m.get_number_of_likes(), 0);
			}
			repo.DeleteMovie(id);
			repo.DeleteMovieFromFile(id, "2 - RepoTest.txt");
			Assert::AreEqual(repo.getMovies().getSize(), 3);
		...
		TEST_METHOD(test_file_ctrl_update_title)
		{
			...
			Assert::AreEqual(ctrl.get_all_movies().getSize(), 4);
		...
		TEST_METHOD(test_file_ctrl_update_genre)
		{
			...
			for (int i = 0; i < vector.getSize(); i++)
			{
				Movie m = movie[i];
				if (m.get_id() == ID)
					Assert::AreEqual(m.get_genre(), string("Adventure"));
			}
			ctrl.delete_movie_from_repository(ID);
			ctrl.delete_movie_from_file(ID, "2 - RepoTest.txt");
			Assert::AreEqual(ctrl.get_all_movies().getSize(), 3);
		...
		TEST_METHOD (test_file_ctrl_update_trailer)
		{
		...
		TEST_METHOD (test_file_ctrl_update_number_of_likes)
		{
